...
import ReturnButton2 from "../../components/ReturnButton2";
  ...
  return (
    ...
    <div className=" text-blue-dark h-full flex items-center justify-start pt-10 gap-2 flex-col bg-blue-lighter mt-10">
      ...
      <div className="w-full flex flex-col p-3 md:p-10 gap-4 text-white-main">
        <div className="flex flex-col md:flex-row  h-full md:flex gap-4 justify-between items-center w-full text-white-main">
